...
Version  : 3.38
Release  : 70
URL      : https://github.com/axboe/fio/archive/fio-3.38/fio-3.38.tar.gz
Source0  : https://github.com/axboe/fio/archive/fio-3.38/fio-3.38.tar.gz
...
%prep
%setup -q -n fio-fio-3.38
cd %{_builddir}/fio-fio-3.38
%patch -P 1 -p1
pushd ..
cp -a fio-fio-3.38 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727969036
