...
Version  : 3.33
Release  : 63
URL      : https://github.com/axboe/fio/archive/fio-3.33/fio-3.33.tar.gz
Source0  : https://github.com/axboe/fio/archive/fio-3.33/fio-3.33.tar.gz
...
%prep
%setup -q -n fio-fio-3.33
cd %{_builddir}/fio-fio-3.33
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667833145
