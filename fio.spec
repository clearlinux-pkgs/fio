...
Version  : 3.25
Release  : 55
URL      : https://github.com/axboe/fio/archive/fio-3.25/fio-3.25.tar.gz
Source0  : https://github.com/axboe/fio/archive/fio-3.25/fio-3.25.tar.gz
...
%prep
%setup -q -n fio-fio-3.25
cd %{_builddir}/fio-fio-3.25
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1607357116
...
cp %{_builddir}/fio-fio-3.25/COPYING %{buildroot}/usr/share/package-licenses/fio/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/fio-fio-3.25/MORAL-LICENSE %{buildroot}/usr/share/package-licenses/fio/ffb3881ef6e7ef966b9fce711e1596d92a0e1e58
%make_install
