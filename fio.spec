...
Source0  : https://github.com/axboe/fio/archive/fio-3.36/fio-3.36.tar.gz
...
%prep
%setup -q -n fio-fio-3.36
cd %{_builddir}/fio-fio-3.36
%patch -P 1 -p1
pushd ..
cp -a fio-fio-3.36 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701955305
