...
Version  : 3.23
Release  : 53
URL      : https://github.com/axboe/fio/archive/fio-3.23/fio-3.23.tar.gz
Source0  : https://github.com/axboe/fio/archive/fio-3.23/fio-3.23.tar.gz
...
%prep
%setup -q -n fio-fio-3.23
cd %{_builddir}/fio-fio-3.23
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1599597511
...
cp %{_builddir}/fio-fio-3.23/COPYING %{buildroot}/usr/share/package-licenses/fio/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/fio-fio-3.23/MORAL-LICENSE %{buildroot}/usr/share/package-licenses/fio/ffb3881ef6e7ef966b9fce711e1596d92a0e1e58
%make_install
