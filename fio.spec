...
Version  : 3.31
Release  : 61
URL      : https://github.com/axboe/fio/archive/fio-3.31/fio-3.31.tar.gz
Source0  : https://github.com/axboe/fio/archive/fio-3.31/fio-3.31.tar.gz
...
%prep
%setup -q -n fio-fio-3.31
cd %{_builddir}/fio-fio-3.31
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660142672
