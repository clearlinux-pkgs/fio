...
Source0  : https://github.com/axboe/fio/archive/fio-3.37/fio-3.37.tar.gz
...
%prep
%setup -q -n fio-fio-3.37
cd %{_builddir}/fio-fio-3.37
%patch -P 1 -p1
pushd ..
cp -a fio-fio-3.37 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711500218
