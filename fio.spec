...
Version  : 3.18
Release  : 48
URL      : https://github.com/axboe/fio/archive/fio-3.18/fio-3.18.tar.gz
Source0  : https://github.com/axboe/fio/archive/fio-3.18/fio-3.18.tar.gz
Summary  : Scriptable I/O tool for storage benchmarks and drive testing
...
%prep
%setup -q -n fio-fio-3.18
cd %{_builddir}/fio-fio-3.18
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581377140
...
cp %{_builddir}/fio-fio-3.18/COPYING %{buildroot}/usr/share/package-licenses/fio/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/fio-fio-3.18/MORAL-LICENSE %{buildroot}/usr/share/package-licenses/fio/ffb3881ef6e7ef966b9fce711e1596d92a0e1e58
%make_install
